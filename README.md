...
- Como o backend utiliza essa chave

No servidor Kotlin (Ktor), você deve colocar sua API Keyou arquivo application.conf e então enviar essa chave no cabeçalho Authorization quando chamar a Groq API.
