...
import { useNavigation } from "@react-navigation/native"; // 🔑 import navegação
...
export default function ChatScreen() {
  ...
  const navigation = useNavigation(); // 🔑 referência de navegação
  ...
  const handleSend = async () => {
    ...
    // 🔎 Detecta padrão "eu quero chegar em DESTINO a partir do ORIGEM"
    ...
    if (match) {
      ...
      navigation.navigate("Mapa", { origem, destino }); // 🔑 navega para MapaScreen
      return; // não chama backend nesse caso
    }
